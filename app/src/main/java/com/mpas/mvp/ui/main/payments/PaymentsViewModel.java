...
public class PaymentsViewModel extends ViewModel {
    private static final String TAG = PaymentsViewModel.class.getSimpleName();
    ...
    public void retrofitGetInfo(String _uid, String  uid){
        ...
        PaymentsViewModel._uid = _uid;
        PaymentsViewModel.uid = uid;

        Log.e("_uid : " , PaymentsViewModel._uid);
        Log.e("uid : ", PaymentsViewModel.uid);
        ...
        public void onResponse(HashMap<String, String> responseMap) {
            ...
            try {
                ...
                if (Objects.requireNonNull(responseMap.get("resultCode")).equals("0000") || Objects.requireNonNull(responseMap.get("resultCode")).equals("0100")) {
                    ...
                    mpmCommit.setApp_no((Objects.requireNonNull(responseMap.get("authNum"))).trim());
